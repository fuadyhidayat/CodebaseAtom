...
public static class UIDisplayTextFor
{
    ...
    public const string Unpublish = nameof(Unpublish);
    ...
    public const string Recall = nameof(Recall);
    public const string Recalled = nameof(Recalled);
    public const string Retract = nameof(Retract);
    public const string Retracted = nameof(Retracted);
    ...
    public const string Searched = nameof(Searched);
    ...
    public const string Notified = nameof(Notified);
